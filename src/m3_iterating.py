...
def run_test_count_negatives():
    ...
    # -------------------------------------------------------------------------
    # TDONE: 2. Implement this TEST function.
    ...
    # Test 6:
    expected = 3
    actual = count_negatives((-2, 12, -8, -5))
    print()
    ...
    # Test 7:
    expected = 2
    actual = count_negatives((-1, -13, 0, 6))
    print()
...
def run_test_count_short_ones():
    ...
    # Test 9:
    expected = 2
    seq = ['its','never','said,','a','bad','word','about','me']
    actual = count_short_ones(seq)
    print()
